...
`,H="I",X="J",Y="L",K="O",Q="S",V="T",ee="Z",te=[H,X,Y,K,Q,V,ee],oe=new Array(16).fill(new Array(16).fill(0)),re=new Array(16).fill(new Array(16).fill(1)),ne=T.addFolder("colors"),ae=T,se=[16,16],ie=e=>e.map((e=>e.map((e=>{return t=e,te.indexOf(t)>-1?[...ce[e](),1]:1===e?[1,1,1,1]:[0,0,0,0];var t})))),ce={I:ne.auto("#ff9b0d","I").map(I),J:ne.auto("#497bff","J").map(I),L:ne.auto("#ff5d5d","L").map(I),O:ne.auto("#00f0ff","O").map(I),S:ne.auto("#00ff86","S").map(I),T:ne.auto("#ff74d1","T").map(I),Z:ne.auto("#fffb51","Z").map(I)},le=T.addFolder("Audio").auto(60,"BPM"),pe={I:[[H,H,H,H]],T:[[V,V,V],[0,V,0]],J:[[0,X],[0,X],[X,X]],L:[[Y,0],[Y,0],[Y,Y]],S:[[0,Q,Q],[Q,Q,0]],Z:[[ee,ee,0],[0,ee,ee]],O:[[K,K],[K,K]]},de=e=>({height:pe[e].length,width:pe[e][0].length}),ue=e=>{const{height:t,width:o}=de(e),r=16-t,n=16-o;return[Math.floor(Math.random()*r),Math.floor(Math.random()*n)]};var me;const fe=(me=w,e=>(...t)=>e(me(),...t))(b),ve=(e,t,o)=>{const[r,n]=o;return[r<0?0:r>e?e:r,n<0?0:n>t?t:n]},he=[0,-1],ye=[0,1],be=[-1,0],we=[1,0],ge={playerBoard:{tetronimoes:[{tetronimo:V,position:[0,0]}],holes:[],walls:[],boardType:0},stack:[...h.range(0,7).map((()=>({tetronimoes:[],holes:[],walls:[],boardType:0})))]},xe=(e,t)=>{const o=a(a({},e.stack[0]),{tetronimoes:[...e.playerBoard.tetronimoes,...e.stack[0].tetronimoes],holes:[...e.stack[0].holes],walls:[...e.stack[0].walls],boardType:e.stack[0].boardType});var r;return{playerBoard:o,stack:[...e.stack.slice(1),t%8==0?(r=o.tetronimoes,{tetronimoes:[],holes:r.map((e=>e.tetronimo)).map((e=>({tetronimo:e,position:ue(e)}))),walls:[],boardType:1}):{tetronimoes:[],holes:[],walls:[],boardType:0}]}},ke=e=>{let t=1===e.boardType?re:oe;return e.walls.forEach((e=>{t=S(t,pe[e.tetronimo],e.position,1)})),e.holes.forEach((e=>{t=S(t,pe[e.tetronimo],e.position,0)})),e.tetronimoes.forEach((e=>{t=S(t,pe[e.tetronimo],e.position,e.tetronimo)})),t},Ae=e=>{const t=[];return t.push(ke(e.playerBoard)),e.stack.forEach((e=>t.push(ke(e)))),t},Oe=(e,t)=>{const o=e.playerBoard.tetronimoes.map((e=>{const o=fe(e.position,t),{width:r,height:n}=de(e.tetronimo);return a(a({},e),{position:ve(16-n,16-r,o)})}));return a(a({},e),{playerBoard:a(a({},e.playerBoard),{tetronimoes:o})})};let $e=-1,Fe=ge,Ee=Ae(Fe),Ie=0;const je=g({extensions:["OES_texture_float"]}),qe=new x;qe.showPanel(0),document.body.appendChild(qe.dom);const Te=(e=>{const t=(e=>{let t=h.range(0,8).map((()=>e.texture({min:"nearest",mag:"nearest",format:"rgba",type:"float32",shape:se,wrap:"repeat"})));return{update:y.flow((e=>e.map(ie)),(e=>e.map(((e,o)=>t[o].subimage(e))))),draw:C`
    ${Z}
    ${G}
  ...
  `}})(e);return k.on((()=>{t.update(Ee)}),B),k.on((()=>{Ie+=M(),Ie>1/(le()/60)&&($e++,Ie=0,Fe=xe(Fe,$e),Ee=Ae(Fe))}),M),_.map((e=>{e.a&&(Fe=Oe(Fe,he)),e.s&&(Fe=Oe(Fe,we)),e.d&&(Fe=Oe(Fe,ye)),e.w&&(Fe=Oe(Fe,be)),e.r&&($e++,Fe=xe(Fe,$e))})).map((()=>{Ee=Ae(Fe)})),e(t.draw)})(je);k.on((()=>{je.poll(),Te(),qe.update()}),B);

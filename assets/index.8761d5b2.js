...
`,G="I",H="J",X="L",Y="O",K="S",Q="T",V="Z",ee=[G,H,X,Y,K,Q,V],te=new Array(16).fill(new Array(16).fill(0)),oe=new Array(16).fill(new Array(16).fill(1)),re=q.addFolder("colors"),ne=q,ae=[16,16],se=e=>e.map((e=>e.map((e=>{return t=e,ee.indexOf(t)>-1?[...ie[e](),1]:1===e?[1,1,1,1]:[0,0,0,0];var t})))),ie={I:re.auto("#ff9b0d","I").map(I),J:re.auto("#497bff","J").map(I),L:re.auto("#ff5d5d","L").map(I),O:re.auto("#00f0ff","O").map(I),S:re.auto("#00ff86","S").map(I),T:re.auto("#ff74d1","T").map(I),Z:re.auto("#fffb51","Z").map(I)},ce={I:[[G,G,G,G]],T:[[Q,Q,Q],[0,Q,0]],J:[[0,H],[0,H],[H,H]],L:[[X,0],[X,0],[X,X]],S:[[0,K,K],[K,K,0]],Z:[[V,V,0],[0,V,V]],O:[[Y,Y],[Y,Y]]},le=e=>({height:ce[e].length,width:ce[e][0].length}),pe=e=>{const{height:t,width:o}=le(e),r=16-t,n=16-o;return[Math.floor(Math.random()*r),Math.floor(Math.random()*n)]};var de;const ue=(de=w,e=>(...t)=>e(de(),...t))(b),me=(e,t,o)=>{const[r,n]=o;return[r<0?0:r>e?e:r,n<0?0:n>t?t:n]},fe=[0,-1],ve=[0,1],he=[-1,0],ye=[1,0],be={playerBoard:{tetronimoes:[{tetronimo:Q,position:[0,0]}],holes:[],walls:[],boardType:0},stack:[...h.range(0,6).map((()=>({tetronimoes:[],holes:[],walls:[],boardType:0}))),{tetronimoes:[],holes:[{tetronimo:Q,position:[3,2]}],walls:[],boardType:1}]},we=e=>{let t=1===e.boardType?oe:te;return e.walls.forEach((e=>{t=M(t,ce[e.tetronimo],e.position,1)})),e.holes.forEach((e=>{t=M(t,ce[e.tetronimo],e.position,0)})),e.tetronimoes.forEach((e=>{t=M(t,ce[e.tetronimo],e.position,e.tetronimo)})),t},ge=e=>{const t=[];return t.push(we(e.playerBoard)),e.stack.forEach((e=>t.push(we(e)))),t},xe=(e,t)=>{const o=e.playerBoard.tetronimoes.map((e=>{const o=ue(e.position,t),{width:r,height:n}=le(e.tetronimo);return a(a({},e),{position:me(16-n,16-r,o)})}));return a(a({},e),{playerBoard:a(a({},e.playerBoard),{tetronimoes:o})})};let ke=be,Ae=ge(ke),Oe=0;const $e=g({extensions:["OES_texture_float"]}),Fe=new x;Fe.showPanel(0),document.body.appendChild(Fe.dom);const Ee=(e=>{const t=(e=>{let t=h.range(0,8).map((()=>e.texture({min:"nearest",mag:"nearest",format:"rgba",type:"float32",shape:ae,wrap:"repeat"})));return{update:y.flow((e=>e.map(se)),(e=>e.map(((e,o)=>t[o].subimage(e))))),draw:S`
  ...
  `}})(e);return k.on((()=>{t.update(Ae)}),_),B.map((e=>{e.a&&(ke=xe(ke,fe)),e.s&&(ke=xe(ke,ye)),e.d&&(ke=xe(ke,ve)),e.w&&(ke=xe(ke,he)),e.r&&(Oe++,ke=((e,t)=>{const o=a(a({},e.stack[0]),{tetronimoes:[...e.playerBoard.tetronimoes,...e.stack[0].tetronimoes],holes:[...e.stack[0].holes],walls:[...e.stack[0].walls],boardType:e.stack[0].boardType});var r;return{playerBoard:o,stack:[...e.stack.slice(1),t%9==0?(r=o.tetronimoes,{tetronimoes:[],holes:r.map((e=>e.tetronimo)).map((e=>({tetronimo:e,position:pe(e)}))),walls:[],boardType:1}):{tetronimoes:[],holes:[],walls:[],boardType:0}]}})(ke,Oe))})).map((()=>{Ae=ge(ke)})),e(t.draw)})($e);k.on((()=>{$e.poll(),Ee(),Fe.update()}),_);

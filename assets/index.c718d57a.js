...
`,K="I",Q="J",V="L",ee="O",te="S",oe="T",re="Z",ae=[K,Q,V,ee,te,oe,re],ne=new Array(16).fill(new Array(16).fill(0)),se=new Array(16).fill(new Array(16).fill(1)),ie=M.addFolder("graphics"),ce=[16,16],le=e=>e.map((e=>e.map((e=>{return t=e,ae.indexOf(t)>-1?[...pe[e](),1]:1===e?[1,1,1,1]:[0,0,0,0];var t})))),pe={I:ie.auto("#ff9b0d","I").map(q),J:ie.auto("#497bff","J").map(q),L:ie.auto("#ff5d5d","L").map(q),O:ie.auto("#00f0ff","O").map(q),S:ie.auto("#00ff86","S").map(q),T:ie.auto("#ff74d1","T").map(q),Z:ie.auto("#fffb51","Z").map(q)},de=M.addFolder("audio").auto(120,"BPM",60,240),ue=(new y).toDestination(),me={I:[[K,K,K,K]],T:[[oe,oe,oe],[0,oe,0]],J:[[0,Q],[0,Q],[Q,Q]],L:[[V,0],[V,0],[V,V]],S:[[0,te,te],[te,te,0]],Z:[[re,re,0],[0,re,re]],O:[[ee,ee],[ee,ee]]},fe=e=>({height:me[e].length,width:me[e][0].length}),ve=e=>{const{height:t,width:o}=fe(e),r=16-t,a=16-o;return[Math.floor(Math.random()*r),Math.floor(Math.random()*a)]};var he;const be=(he=k,e=>(...t)=>e(he(),...t))(x),ye=(e,t,o)=>{const[r,a]=o;return[r<0?0:r>e?e:r,a<0?0:a>t?t:a]},we=[0,-1],ge=[0,1],xe=[-1,0],ke=[1,0],Ae={playerBoard:{tetronimoes:[{tetronimo:oe,position:[0,0]}],holes:[],walls:[],boardType:0},stack:[...h.range(0,7).map((()=>({tetronimoes:[],holes:[],walls:[],boardType:0})))]},Oe=(e,t)=>{const o=n(n({},e.stack[0]),{tetronimoes:[...e.playerBoard.tetronimoes,...e.stack[0].tetronimoes],holes:[...e.stack[0].holes],walls:[...e.stack[0].walls],boardType:e.stack[0].boardType});var r;return{playerBoard:o,stack:[...e.stack.slice(1),t%8==0?(r=o.tetronimoes,{tetronimoes:[],holes:r.map((e=>e.tetronimo)).map((e=>({tetronimo:e,position:ve(e)}))),walls:[],boardType:1}):{tetronimoes:[],holes:[],walls:[],boardType:0}]}},$e=e=>{let t=1===e.boardType?se:ne;return e.walls.forEach((e=>{t=P(t,me[e.tetronimo],e.position,1)})),e.holes.forEach((e=>{t=P(t,me[e.tetronimo],e.position,0)})),e.tetronimoes.forEach((e=>{t=P(t,me[e.tetronimo],e.position,e.tetronimo)})),t},Fe=e=>{const t=[];return t.push($e(e.playerBoard)),e.stack.forEach((e=>t.push($e(e)))),t},Ee=(e,t)=>{const o=e.playerBoard.tetronimoes.map((e=>{const o=be(e.position,t),{width:r,height:a}=fe(e.tetronimo);return n(n({},e),{position:ye(16-a,16-r,o)})}));return n(n({},e),{playerBoard:n(n({},e.playerBoard),{tetronimoes:o})})};let je=!1;let Ce=-1,Ie=Ae,qe=Fe(Ie),Te=0;const Be=A({extensions:["OES_texture_float"]}),Me=new O;Me.showPanel(0),document.body.appendChild(Me.dom);const _e=(e=>{const t=(e=>{let t=h.range(0,8).map((()=>e.texture({min:"nearest",mag:"nearest",format:"rgba",type:"float32",shape:ce,wrap:"repeat"})));return{update:b.flow((e=>e.map(le)),(e=>e.map(((e,o)=>t[o].subimage(e))))),draw:U`
    ${X}
    ${Y}
  ...
  `}})(e);return $.on((()=>{t.update(qe)}),_),$.on((()=>{var e;Te+=L(),Te>1/(de()/60)&&(Ce++,Te=0,Ie=Oe(Ie,Ce),qe=Fe(Ie),je&&(e=Ce,g(),ue.triggerAttackRelease(e%8==0?"C5":"C4","8n")))}),L),S.map((e=>(e.a&&(Ie=Ee(Ie,we)),e.s&&(Ie=Ee(Ie,ke)),e.d&&(Ie=Ee(Ie,ge)),e.w&&(Ie=Ee(Ie,xe)),e.r&&(Ce++,Ie=Oe(Ie,Ce)),e))).map((e=>{!je&&Object.keys(e).length&&(w(),je=!0),qe=Fe(Ie)})),e(t.draw)})(Be);$.on((()=>{Be.poll(),_e(),Me.update()}),_);

...
`,H="I",X="J",Y="L",K="O",Q="S",V="T",ee="Z",te=[H,X,Y,K,Q,V,ee],oe=new Array(16).fill(new Array(16).fill(0)),re=new Array(16).fill(new Array(16).fill(1)),ne=q.addFolder("colors"),ae=q,se=[16,16],ie=e=>e.map((e=>e.map((e=>{return t=e,te.indexOf(t)>-1?[...ce[e](),1]:1===e?[1,1,1,1]:[0,0,0,0];var t})))),ce={I:ne.auto("#ff9b0d","I").map(I),J:ne.auto("#497bff","J").map(I),L:ne.auto("#ff5d5d","L").map(I),O:ne.auto("#00f0ff","O").map(I),S:ne.auto("#00ff86","S").map(I),T:ne.auto("#ff74d1","T").map(I),Z:ne.auto("#fffb51","Z").map(I)},le={I:[[H,H,H,H]],T:[[V,V,V],[0,V,0]],J:[[0,X],[0,X],[X,X]],L:[[Y,0],[Y,0],[Y,Y]],S:[[0,Q,Q],[Q,Q,0]],Z:[[ee,ee,0],[0,ee,ee]],O:[[K,K],[K,K]]},pe=e=>({height:le[e].length,width:le[e][0].length}),de=e=>{const{height:t,width:o}=pe(e),r=16-t,n=16-o;return[Math.floor(Math.random()*r),Math.floor(Math.random()*n)]};var ue;const me=(ue=w,e=>(...t)=>e(ue(),...t))(b),fe=(e,t,o)=>{const[r,n]=o;return[r<0?0:r>e?e:r,n<0?0:n>t?t:n]},ve=[0,-1],he=[0,1],ye=[-1,0],be=[1,0],we={playerBoard:{tetronimoes:[{tetronimo:V,position:[0,0]}],holes:[],walls:[],boardType:0},stack:[...h.range(0,6).map((()=>({tetronimoes:[],holes:[],walls:[],boardType:0}))),{tetronimoes:[],holes:[{tetronimo:V,position:[3,2]}],walls:[],boardType:1}]},ge=(e,t)=>{const o=a(a({},e.stack[0]),{tetronimoes:[...e.playerBoard.tetronimoes,...e.stack[0].tetronimoes],holes:[...e.stack[0].holes],walls:[...e.stack[0].walls],boardType:e.stack[0].boardType});var r;return{playerBoard:o,stack:[...e.stack.slice(1),t%9==0?(r=o.tetronimoes,{tetronimoes:[],holes:r.map((e=>e.tetronimo)).map((e=>({tetronimo:e,position:de(e)}))),walls:[],boardType:1}):{tetronimoes:[],holes:[],walls:[],boardType:0}]}},xe=e=>{let t=1===e.boardType?re:oe;return e.walls.forEach((e=>{t=S(t,le[e.tetronimo],e.position,1)})),e.holes.forEach((e=>{t=S(t,le[e.tetronimo],e.position,0)})),e.tetronimoes.forEach((e=>{t=S(t,le[e.tetronimo],e.position,e.tetronimo)})),t},ke=e=>{const t=[];return t.push(xe(e.playerBoard)),e.stack.forEach((e=>t.push(xe(e)))),t},Ae=(e,t)=>{const o=e.playerBoard.tetronimoes.map((e=>{const o=me(e.position,t),{width:r,height:n}=pe(e.tetronimo);return a(a({},e),{position:fe(16-n,16-r,o)})}));return a(a({},e),{playerBoard:a(a({},e.playerBoard),{tetronimoes:o})})};let Oe=we,$e=ke(Oe),Fe=0,Ee=0;const Ie=g({extensions:["OES_texture_float"]}),Te=new x;Te.showPanel(0),document.body.appendChild(Te.dom);const je=(e=>{const t=(e=>{let t=h.range(0,8).map((()=>e.texture({min:"nearest",mag:"nearest",format:"rgba",type:"float32",shape:se,wrap:"repeat"})));return{update:y.flow((e=>e.map(ie)),(e=>e.map(((e,o)=>t[o].subimage(e))))),draw:C`
    ${Z}
    ${G}
  ...
  `}})(e);return k.on((()=>{t.update($e)}),_),k.on((()=>{Ee+=B(),Ee>1&&(Fe++,Ee=0,Oe=ge(Oe,Fe),$e=ke(Oe))}),B),L.map((e=>{e.a&&(Oe=Ae(Oe,ve)),e.s&&(Oe=Ae(Oe,be)),e.d&&(Oe=Ae(Oe,he)),e.w&&(Oe=Ae(Oe,ye)),e.r&&(Fe++,Oe=ge(Oe,Fe))})).map((()=>{$e=ke(Oe)})),e(t.draw)})(Ie);k.on((()=>{Ie.poll(),je(),Te.update()}),_);

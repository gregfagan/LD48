...
`,R="I",U="J",C="L",T="O",z="S",J="T",N="Z",Z=[R,U,C,T,z,J,N],B=new Array(16).fill(new Array(16).fill(0)),D=$.addFolder("colors"),G=[16,16],H=e=>e.map((e=>e.map((e=>{return t=e,Z.indexOf(t)>-1?[...W[e](),1]:[0,0,0,0];var t})))),W={I:D.auto("#ff9b0d","I").map(j),J:D.auto("#497bff","J").map(j),L:D.auto("#ff5d5d","L").map(j),O:D.auto("#00f0ff","O").map(j),S:D.auto("#00ff86","S").map(j),T:D.auto("#ff74d1","T").map(j),Z:D.auto("#fffb51","Z").map(j)},X={I:[[R,R,R,R]],T:[[J,J,J],[0,J,0]],J:[[0,U],[0,U],[U,U]],L:[[C,0],[C,0],[C,C]],S:[[0,z,z],[z,z,0]],Z:[[N,N,0],[0,N,N]],O:[[T,T],[T,T]]},Y=[0,-1],K=[0,1],Q=[-1,0],V=[1,0],ee=(e,t,o)=>e.map(((r,n)=>e[o[0]].map(((e,r)=>((e,t,o)=>{const r=X[e];return r[t]&&r[t][o]})(t,n-o[0],r-o[1])?t:e)))),te=e=>{let t=B;return e.tetronimoes.forEach((e=>{t=ee(t,e.tetronimo,e.position)})),t},oe=(e,t)=>{const o=e.tetronimoes.map((e=>{const o=e.position[0]+t[0],r=e.position[1]+t[1],{width:n,height:i}=(s=e.tetronimo,{height:X[s].length,width:X[s][0].length});var s;const c=r>=0&&r+n<=16,p=o>=0&&o+i<=16?o:e.position[0],l=c?r:e.position[1];return a(a({},e),{position:[p,l]})}));return a(a({},e),{tetronimoes:o})};let re={tetronimoes:[{tetronimo:J,position:[0,0]}]},ne=te(re);const ae=h({extensions:["OES_texture_float"]}),ie=new w;ie.showPanel(0),document.body.appendChild(ie.dom);const se=(e=>{const t=(e=>{let t=e.texture({min:"nearest",mag:"nearest",format:"rgba",type:"float32",shape:G,wrap:"repeat"});return{update:b.flow(H,(e=>t.subimage(e))),draw:_`
    ${M}
    ${P}
  ...
  `}})(e);return y.on((()=>{t.update(ne)}),A),E.map((e=>{e.a&&(re=oe(re,Y)),e.s&&(re=oe(re,V)),e.d&&(re=oe(re,K)),e.w&&(re=oe(re,Q))})).map((()=>{ne=te(re)})),e(t.draw)})(ae);y.on((()=>{ae.poll(),se(),ie.update()}),A);
